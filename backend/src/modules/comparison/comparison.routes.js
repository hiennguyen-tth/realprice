...
router.post('/:id/items', optionalAuthenticate, validate(addListingSchema), compCtrl.addListing);
router.delete('/:id/:listingId', optionalAuthenticate, compCtrl.removeListing);
router.delete('/:id/items/:listingId', optionalAuthenticate, compCtrl.removeListing);
